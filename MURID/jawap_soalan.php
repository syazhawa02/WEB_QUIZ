...
while ($data=mysqli_fetch_array($laksana))
{
    ...
    else
    {
        ...
        # medan,jawapan, jawapan1, jawapan2, jawapan3, jawapan 4, soalan, nilai jawapan_a
        echo"
        <br><img src='$gambar'><br>
        <input class='w3-radio' type='radio' name='s".$data['no_soalan']."' value='".$a[0]."|".$data[$a[0]]."|".$data[$a[0]]."|".$data[$a[1]]."|".$data[$a[2]]."|".$data[$a[3]]."|".$soalan."|".$data['jawapan_a']."|".$gambar."'>
        <label>".$data[$a[0]]."</label><br>
        <input class='w3-radio' type='radio' name='s".$data['no_soalan']."' value='".$a[1]."|".$data[$a[1]]."|".$data[$a[0]]."|".$data[$a[1]]."|".$data[$a[2]]."|".$data[$a[3]]."|".$soalan."|".$data['jawapan_a']."|".$gambar."'>
        <label>".$data[$a[1]]."</label><br>
        <input class='w3-radio' type='radio' name='s".$data['no_soalan']."' value='".$a[2]."|".$data[$a[2]]."|".$data[$a[0]]."|".$data[$a[1]]."|".$data[$a[2]]."|".$data[$a[3]]."|".$soalan."|".$data['jawapan_a']."|".$gambar."'>
        <label>".$data[$a[2]]."</label><br>
        <input class='w3-radio' type='radio' name='s".$data['no_soalan']."' value='".$a[3]."|".$data[$a[3]]."|".$data[$a[0]]."|".$data[$a[1]]."|".$data[$a[2]]."|".$data[$a[3]]."|".$soalan."|".$data['jawapan_a']."|".$gambar."'>
...
<input class='w3-margin-top w3-button w3-khaki w3-block' type='submit' value='Hantar'>
