...
enctype='multipart/form-data'> 
  ...
  <input class='w3-block w3-margin-top w3-button w3-amber' type='file' name='file' required/>
  <button class='w3-margin-bottom w3-margin-top w3-button w3-amber' type='submit' name='btn-upload'>upload</button>
</form>
</div>
<?PHP 
