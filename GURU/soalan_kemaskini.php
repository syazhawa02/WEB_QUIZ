...
<table border='1' id='besar'class= 'w3-table-all w3-hoverable w3-margin-top'>
    ...
    <!-- Bahagian borang untuk mengemaskini soalan dan jawapan-->
        <form action='' method='POST'>
            ...
            <td bgcolor='cyan'><textarea class='input' name='jawapan_a' rows="4" cols="25"><?PHP echo $_GET['jawapan_a']; ?></textarea></td>
            <td bgcolor='pink'><textarea class='input' name='jawapan_b' rows="4" cols="25"><?PHP echo $_GET['jawapan_b']; ?></textarea></td>
            <td bgcolor='pink'><textarea class='input' name='jawapan_c' rows="4" cols="25"><?PHP echo $_GET['jawapan_c']; ?></textarea></td>
            <td bgcolor='pink'><textarea class='input' name='jawapan_d' rows="4" cols="25"><?PHP echo $_GET['jawapan_d']; ?></textarea></td>           
...
while ($data=mysqli_fetch_array($laksana_soalan))
{
 ...
 <a href='soalan_kemaskini.php?".http_build_query($data_get)."'title='Kemaskini'><i class='w3-text-yellow w3-xxlarge fa fa-pencil' aria-hidden='true'></i> </a>
 <a href='padam.php?jadual=soalan&medan=no_soalan&kp=".$data['no_soalan']."'title='DELETE' ><i class='w3-text-red w3-xxlarge fa fa-trash-o' aria-hidden='true'></i></a>   
