...
<h3>Kemaskini Murid</h3>
</div>
<?PHP include ('../butang_saiz.php'); ?>
<!-- link untuk memuat naik fail data murid-->
<a class=' w3-margin-bottom w3-button w3-khaki' href='murid_upload.php'>[+] Upload Data Murid</a>
...
while ($data=mysqli_fetch_array($laksana_cari_murid))
{
    ...
    <tr>
        ...
        <td class='w3-center'>
             ...
             <a href='padam.php?jadual=murid&medan=nokp_murid&kp=".$data['nokp_murid']."' title='DELETE' ><i class='w3-text-red w3-xxlarge fa fa-trash-o' aria-hidden='true'></i></a> </a> 
        </td> 
    </tr>";
}
?>
