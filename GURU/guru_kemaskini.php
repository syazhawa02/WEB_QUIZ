...
while ($data=mysqli_fetch_array($laksana_cari_guru))
{
    ...
    echo "<tr>
        ...
        <td>".$data['tahap']."</td>
        <td class='w3-center'>
            <a href='guru_kemaskini.php?".http_build_query($data_guru)."' title='Kemaskini'><i class='w3-text-yellow w3-xxlarge fa fa-pencil' aria-hidden='true'></i> </a> </a>
            <a href='padam.php?jadual=guru&medan=nokp_guru&kp=".$data['nokp_guru']."' title='DELETE' ><i class='w3-text-red w3-xxlarge fa fa-trash-o' aria-hidden='true'></i></a>   </a> 
        </td> 
    </tr>";
}
?>
