...
<div class="w3-row">
  ...
  <div class="w3-third w3-container w3-teal">
...
<label class="w3-text-white"><b>TOPIK</b></label>
<select class='w3-select  w3-border'  name='no_set'">
        <option value selected disable>Pilih</option>
    <?PHP 
    if($_SESSION['tahap']=='ADMIN')
    {
...
<br>
<input class='w3-block w3-margin-top w3-button w3-pale-green' type='submit' value = 'Papar Keputusan'>
</form>
...
if(!empty($_POST))
{
    ...
    if(mysqli_num_rows($laksana_pilih)>=1)
    {
        ...
        <br>Kelas : $nama_kelas
        <br>Topik : $nama_topik
        <br><button onclick='window.print()'><i class=' w3-xxlarge fa fa-print' aria-hidden='true'></i></button>";
